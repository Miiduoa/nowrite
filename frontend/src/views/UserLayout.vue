...
export default {
  ...
  data() {
    return {
      ...
      currentView: 'UserLogin',  // 預設顯示登入元件
      isModalOpen: false,
      navbarVisible: false,
  ...
  watch: {
    selectedLanguage(newLang) {
      // 當用戶選擇一個新的語言時，你可以在這裡改變你的語言設定
      // 例如，你可以呼叫 vue-i18n 的語言切換方法，或者更改你的頁面上的文本等
...
.modal-overlay {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(20, 16, 12, 0.42);
  display: flex;
