...
# 資料目錄：可由 HW_DATA_DIR 覆寫（離線桌面版指向可寫的 userData 目錄）
_DATA_DIR = Path(os.getenv("HW_DATA_DIR", str(Path(__file__).resolve().parent)))
_DB_PATH = _DATA_DIR / "tasks.db"
_RESULT_DIR = _DATA_DIR / "temp" / "task_results"
_DB_TIMEOUT = 10  # 秒
